...
//[quick
/*` [h4 Another simple example] */
/*` If the defaults offered by the library are not adequate: */
    static const std::size_t max_stack_size = 20;  // Maximum depth of the stack to collect.
    typedef boost::call_stack::call_stack<max_stack_size> stack_type;
    stack_type here(true); // Get the stack. Resolve symbols and print later.
